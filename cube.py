...
def display_cube(cube):
    ...
    print(f"{blank}   {cube[0][0]} {cube[0][1]} {cube[0][2]}   {blank}   {blank}   {blank}")
    print(f"{blank}   {cube[0][3]} {cube[0][4]} {cube[0][5]}   {blank}   {blank}   {blank}")
    print(f"{blank}   {cube[0][6]} {cube[0][7]} {cube[0][8]}   {blank}   {blank}   {blank}")
    print(f"{blank}   {blank}   {blank}   {blank}   {blank}   {blank}   {blank}")
    ...
    print(f"{blank}   {blank}   {cube[2][0]} {cube[2][1]} {cube[2][2]}   {blank}   {blank}   {blank}")
    print(f"{blank}   {blank}   {cube[2][3]} {cube[2][4]} {cube[2][5]}   {blank}   {blank}   {blank}")
    print(f"{blank}   {blank}   {cube[2][6]} {cube[2][7]} {cube[2][8]}   {blank}   {blank}   {blank}")
    print("\n")
